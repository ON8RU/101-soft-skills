...
# Скрипт для генерации промпта с заменой пустых значений на "?"
...
## 11. Книги
// Не нумерованный список
- [Книга именно об этом навыке или с похожим смыслом]
- [Книга именно об этом навыке или с похожим смыслом]
- [Книга именно об этом навыке или с похожим смыслом]
...
// Не нумерованный список
- [Не особо популярный Фильм/мультфильм именно об этом навыке или с похожим смыслом]
- [Не особо популярный Фильм/мультфильм именно об этом навыке или с похожим смыслом]
- [Не особо популярный Фильм/мультфильм именно об этом навыке или с похожим смыслом]
...
Группа навыков: **${ENV_GROUP_SKILLS:-?}**
Категория: **${ENV_CATEGORY_SKILLS:-?}**
Навык: **${ENV_SOFT_SKILL:-?}**
Рекомендуемая Персона: **${ENV_PERSON:-?}**
Рекомендуемая История: **${ENV_HISTORY:-?}**
Рекомендуемая Цитата: **${ENV_QUOTE:-?}**
Рекомендуемые Фильмы/мультфильмы: **${ENV_FILMS:-?}**
EOF
