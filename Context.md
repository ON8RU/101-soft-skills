...
// Разыграть диалог двух/трех людей, один из которых эксперт в навыке, а другой плохо им владеет, а третий (если есть) по необходимости
// Выбери им имена из этих (Анна, Мария, Алиса, Михаил, Иван, Алекс)
